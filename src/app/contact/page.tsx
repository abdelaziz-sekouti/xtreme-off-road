        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h2 className="text-2xl text-accent font-bold mb-6">Nos Coordonnées</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <span className="font-medium text-accent">Adresse:</span>
                  <span className="text-gray-600">{settings.address || "Non défini"}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="font-medium text-accent">Téléphone:</span>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h2 className="text-2xl font-bold  text-accent mb-6">Envoyez-nous un Message</h2>
              <form className="space-y-4">
                <input type="text" placeholder="Votre nom" className="w-full px-4 py-2 border rounded-lg text-accent" required />
                <input type="email" placeholder="Votre email" className="w-full px-4 py-2 border rounded-lg text-accent" required />
                <textarea placeholder="Votre message" rows={4} className="w-full px-4 py-2 border rounded-lg text-accent" required />
