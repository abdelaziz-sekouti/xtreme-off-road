...
export default function FormationPage() {
  ...
  useEffect(() => {
    fetch('/api/admin/services?category=Formation')
      .then(res => res.json())
      .then(data => {
        setServices(data);
        setLoading(false);
    ...
    <main className="min-h-screen">
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-4">Formation Conduite</h1>
          ...
          {services.length === 0 && (
            <p className="text-center text-gray-500 mt-8">Aucune formation disponible pour le moment.</p>
          )}
        </div>
      </section>
    </main>
