    ...
    <main className="min-h-screen">
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-12 text-purple-900">À Propos de Nous</h1>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h2 className="text-xl font-bold mb-4 text-purple-900">Notre Mission</h2>
                <p className="text-gray-600">
                  Offrir des expériences de conduite exceptionnelles en tout-terrain avec une flotte de véhicules haut de gamme.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h2 className="text-xl font-bold mb-4 text-purple-900">Notre Vision</h2>
                <p className="text-gray-600">
